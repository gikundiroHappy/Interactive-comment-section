  ...
  return (
    <>
      ...
      {comments.map((comment) => (
        <div
          key={comment.id}
          className="grid sm:grid-cols-5 md:flex gap-8 bg-white rounded-md p-4 sm:p-5 sm:text-sm m-2 mt-8"
        >
          ...
          <div className="sm:col-span-4 space-y-5 w-full">
            <div className="grid sm:grid-cols-3 ">
              ...
              <div className="hidden sm:block sm:flex justify-end items-center gap-4 col-span-1 ">
                ...
                <div className="flex text-purple-500 font-bold cursor-pointer">
                  ...
                  <p className="" onClick={() => handleEdit(comment.id)}>
                    Edit
                  </p>
                </div>
              </div>
